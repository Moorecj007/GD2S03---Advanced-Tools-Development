...
void CGameTile::SetImage(eImage _eImage)
{
	...
	switch (m_eImage)
	{
		case IMAGE_1:
		{
			m_hSprite = LoadBitmap(hInstance, MAKEINTRESOURCE(IMAGE_1));
		}
		break;
		case IMAGE_2:
		{
			m_hSprite = LoadBitmap(hInstance, MAKEINTRESOURCE(IMAGE_2));
		}
		break;
		case IMAGE_3:
		{
			m_hSprite = LoadBitmap(hInstance, MAKEINTRESOURCE(IMAGE_3));
		}
		break;
		case IMAGE_4:
		{
			m_hSprite = LoadBitmap(hInstance, MAKEINTRESOURCE(IMAGE_4));
		}
		break;
		case IMAGE_5:
		{
			m_hSprite = LoadBitmap(hInstance, MAKEINTRESOURCE(IMAGE_5));
		}
		break;
		case IMAGE_6:
		{
			m_hSprite = LoadBitmap(hInstance, MAKEINTRESOURCE(IMAGE_6));
		}
		break;
		case IMAGE_7:
		{
			m_hSprite = LoadBitmap(hInstance, MAKEINTRESOURCE(IMAGE_7));
		}
		break;
		case IMAGE_8:
		{
			m_hSprite = LoadBitmap(hInstance, MAKEINTRESOURCE(IMAGE_8));
		}
		break;
		case IMAGE_9:
		{
			m_hSprite = LoadBitmap(hInstance, MAKEINTRESOURCE(IMAGE_9));
		}
		break;
		case IMAGE_BLANK:	// Fall Through
		default:
		{
			m_hSprite = LoadBitmap(hInstance, MAKEINTRESOURCE(IMAGE_BLANK));
		}
			break;
	}	// End Switch
